...
const CustomProgressDialoge = ({dialogVisible,setDialogVisible,title,onPress,messageshow=true}) => {
...
style={{height:120,width:100,alignSelf:'center'}}
    ...
    loop
  />
    <TextView type={'heading_20'} text={title}
    style={{color:Colors.darkGreenColor,marginTop:20}}></TextView>

{messageshow && <TextView type={'Light'} text="Make sure your internet is connected!" 
...
export default memo(CustomProgressDialoge);