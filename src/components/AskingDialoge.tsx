...
const AskingDialoge = ({dialogVisible,setDialogVisible,onPress}) => {
...
style={{height:120,width:100,alignSelf:'center'}}
    ...
    loop
  />
    <TextView type={'heading_20'} text="Do you really want to go back?" 
    style={{color:Colors.darkGreenColor,marginTop:20}}></TextView>

<TextView type={'Light'} text="You will be lost all filled data!" 
    style={{color:Colors.light_grey,marginTop:10,alignSelf:'center'}}></TextView>

    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-evenly',
    marginTop:20,}}>
        <Pressable
        onPressIn={()=>{setDialogVisible(false)}}
        style={styles.dialogeButton}>
<TextView type={'Light'} text={"Cancel"} style={{alignSelf:'center'}}></TextView>
        </Pressable>
