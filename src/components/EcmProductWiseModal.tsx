...
const EcmProductWiseModal = ({style,text,required,tempdata,label, onSelect,type=1,sortingTrue=true, onPressDone, filterModal, setfilterModal, esmProductRiskSum, setEsmRsikSum, setEsmRiskArray}) => {
  ...
  return (<View style={{width:"100%",}}>
   ...
   <View style={{flexDirection:"row",}}>
    ...
    {required && <View style={{position:'absolute',right:1,top:-5}}>
        ...
        <Pressable style={[{padding:10, borderRadius:10, width:100, alignItems:"center", height:40, marginLeft:50}, esmProductRiskSum < 2 ? {backgroundColor:"green", }: esmProductRiskSum == 2 ? {backgroundColor:"yellow", } : {backgroundColor:"red", }]}>
            {esmProductRiskSum < 2 ?
                <Text>Low</Text>
                :esmProductRiskSum == 2 ?
                <Text>Medium</Text> 
   ...
   { filterModal && (
      ...
      />
            ...
            <Pressable style={{backgroundColor:Colors.primary, padding:10, marginTop:10, width:100, borderRadius:10, alignItems:"center"}} onPress={onPressDone}>
...
export default memo(EcmProductWiseModal);
