...
let initialState={
    commentsArray:{
        ...
        visitedBorrower:{value: '', error: false,index:0},
        borrowerName:{value: '', error: false},
        borrowerAddress:{value: '', error: false},
        borrowerPhone:{value: '', error: false},
        borrowerStaification:{value: '', error: false,index:0},
        socialAppraisal:{value: '', error: false,index:0},
        borrowerApproval:{value: '', error: false,index:0},
...
export default function CommentsReducer(currentState=initialState,action){
switch (action.type) {
    case "COMMENTARRAY":
        return {
